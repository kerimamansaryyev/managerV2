...
void main() {
  testWidgets(
    ...
    await tester.pumpWidget(MaterialApp(
      home: Builder(builder: (context) {
        return Text(ManagerProvider.maybeOf<
                    manager_provider_test_utils.TestCounterManager>(context)
                ?.state
                .toString() ??
            'null');
      }),
  ...
  testWidgets(
    ...
    await tester.pumpWidget(ManagerProvider.value(
        value: manager,
        builder: (context, __) => MaterialApp(
              home: Text(ManagerProvider.of<
                      manager_provider_test_utils.TestCounterManager>(context)
        ...
        builder: (context, __) => MaterialApp(
              home: Text(ManagerProvider.of<
                      manager_provider_test_utils
                          .TestCounterManager>(context, listen: false)
                  .state
                  .toString()),
            )));
    manager.run(
